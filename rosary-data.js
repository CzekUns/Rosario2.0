      ...
      steps.push(
        createStep(prefix, "Mistero", `${mysteryNumber}. ${title}`, scriptureText, decadeBeadIndex, {
          ...
          speechParts: freezeSpeechParts([
            ...
            {
              speaker: "leader",
              text: `${scriptureSource.startsWith("Dal Vangelo") ? "Ascoltiamo la Parola del Vangelo." : "Ascoltiamo la Parola della Scrittura."} ${scriptureSource}. ${scriptureText}`,
            },
